        ...
        <div class="mt-4">
            <div class="container">
                <div class="card card1" style="width: 65rem">
                    <img class="img-fluid card-img" src="/images/vrz.jpg" alt="#">
                ...
                <div class="row mt-4">
                    <div class="col">
                        <div class="card card2" style="width: 30rem">
                            <img class="img-fluid card-img" src="/images/bwi.jpg" alt="#" style="height: 320px">
                    ...
                    <div class="col">
                        <div class="card card2" style="width: 30rem">
                            <img class="img-fluid card-img" src="/images/testimelia.jpg" alt="#" style="height: 320px">
